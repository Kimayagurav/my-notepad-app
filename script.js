...
function loadNotes() { notes = JSON.parse(localStorage.getItem(getNotesKey()) || "[]"); }
function saveNotes() { localStorage.setItem(getNotesKey(), JSON.stringify(notes)); }
